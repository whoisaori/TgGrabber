...
API_ID = 11325218
API_HASH = 'bb89791185690e6baca9b21ef8ce71c3'

PRIVATE_PUBLIC = 'a7azik'  # скрытый паблик для управления ботом
PUBLIC_PUBLIC = 'public_public_posts'  # паблик куда будем репостить
SOURCE_PUBLICS = [
...
PHONE_NUMBER = '+79507457871'  # номер зарегистрованный в телеграме


# создаем клиент телеграм
app = Client("dadadapzz", api_id=API_ID, api_hash=API_HASH,
...
def new_channel_post(client, message):
    ...
    client.send_message(PRIVATE_PUBLIC, f'id = {post_id}')
...
def post_request(client, message):
    ...
    try:
        ...
        # as_copy=True значит, что мы не будем отображать паблик донор, будто это наш пост
